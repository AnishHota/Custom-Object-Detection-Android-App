...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun runObjectDetection(bitmap: Bitmap) {
        ...
        // Here, they have used different options based on the code.
        // In the first project, they had different functions of the builder, here they have
        // different functions.
        ...
        val resultToDisplay = results.map{
            // Only display the top-1 category
        ...
        runOnUiThread{inputImageView.setImageBitmap(imgWithResult)}
    }
